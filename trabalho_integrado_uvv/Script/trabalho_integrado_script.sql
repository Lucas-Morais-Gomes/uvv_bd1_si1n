...
CREATE TABLE funcionario_talento (
                id_funcionario_talento VARCHAR(255) NOT NULL,
                id_funcionario VARCHAR(38) NOT NULL,
                id_talento VARCHAR(255) NOT NULL,
                CONSTRAINT id_funcionario_talento_pk PRIMARY KEY (id_funcionario_talento)
);
COMMENT ON TABLE funcionario_talento IS 'Tabela para vincular as tabelas funcionario e talento';
COMMENT ON COLUMN funcionario_talento.id_funcionario_talento IS 'Número de Identificação que relaciona funcionario e talento';
...
ALTER TABLE Publicacoes ADD CONSTRAINT talento_publicacoes_fk
...
ALTER TABLE Talento_validacao ADD CONSTRAINT talento_talento_validacao_fk
FOREIGN KEY (id_talento)
REFERENCES Talento (id_talento)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE funcionario_talento ADD CONSTRAINT talento_funcionario_talento_fk
FOREIGN KEY (id_talento)
REFERENCES Talento (id_talento)
ON DELETE NO ACTION
ON UPDATE NO ACTION
...
ALTER TABLE Publicacoes ADD CONSTRAINT funcionario_publicacoes_fk
...
ALTER TABLE funcionario_talento ADD CONSTRAINT funcionario_funcionario_talento_fk
FOREIGN KEY (id_funcionario)
REFERENCES Funcionario (id_funcionario)
ON DELETE NO ACTION
ON UPDATE NO ACTION
